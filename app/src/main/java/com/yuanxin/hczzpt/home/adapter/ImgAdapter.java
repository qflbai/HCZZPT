...
public class ImgAdapter extends RecyclerView.Adapter<ImgAdapter.Holder> {
    ...
    public ImgAdapter(Context context, List<CriminalSuspectInfo> data) {
        this.data = data;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_recycler_platforms_team_lc_info, parent, false);
