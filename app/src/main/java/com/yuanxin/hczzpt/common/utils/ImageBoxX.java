...
/**
 * @author: qflbai
 * @CreateDate: 2020/1/14 16:45
 * @Version: 1.0
 * @description:
 */
public class ImageBoxX extends RecyclerView {
    ...
    public ImageBoxX(Context context) {
        super(context);
        init(context, null);
    }

    public ImageBoxX(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ImageBoxX(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.qflbai.lib.R.styleable.ImageBox);
        mLeftMargin = a.getDimensionPixelSize(com.qflbai.lib.R.styleable.ImageBox_zib_left_margin, 0);
        mRightMargin = a.getDimensionPixelSize(com.qflbai.lib.R.styleable.ImageBox_zib_right_margin, 0);
        mMaxLine = a.getInteger(com.qflbai.lib.R.styleable.ImageBox_zib_max_line, DEFAULT_MAX_LINE);
        mImageSize = a.getInteger(com.qflbai.lib.R.styleable.ImageBox_zib_img_size_one_line, DEFAULT_IMAGE_SIZE);
        mPadding = a.getDimensionPixelSize(com.qflbai.lib.R.styleable.ImageBox_zib_img_padding, DEFAULT_IMAGE_PADDING);
        mDefaultPicId = a.getResourceId(com.qflbai.lib.R.styleable.ImageBox_zib_img_default, -1);
        mDeletePicId = a.getResourceId(com.qflbai.lib.R.styleable.ImageBox_zib_img_delete, -1);
        mAddPicId = a.getResourceId(com.qflbai.lib.R.styleable.ImageBox_zib_img_add, -1);
        mDeletable = a.getBoolean(com.qflbai.lib.R.styleable.ImageBox_zib_img_deletable, DEFAULT_DELETABLE);
        a.recycle();
    ...
    public static class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = mInflater.inflate(R.layout.image_box_itemx, null, true);
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
            ...
            if (holder.getAdapterPosition() == getItemCount() - 1 && !lastOne) {
                ...
                holder.ivPic.setImageResource(addPic == -1 ? com.qflbai.lib.R.mipmap.iv_add : addPic);
                ...
                if (url != null && url.length() != 0) {
                   // if (url.startsWith("http") || forceOnLine) {
                        if (imageLoader != null) {
                            ...
                            holder.ivPic.setImageResource(defaultPic == -1 ? com.qflbai.lib.R.mipmap.iv_default : defaultPic);
                        }
                   // } else {
              ...
              //  holder.ivDelete.setImageResource(deletePic == -1 ? com.qflbai.lib.R.mipmap.iv_delete : deletePic);
